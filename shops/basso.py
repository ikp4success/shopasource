...
from shops.shop_connect.shoplinks import _bassourl
...
class BASSO(scrapy.Spider):
    name = find_shop_configuration("BASSO")["name"]
    ...
    def start_requests(self):
        shop_url = _bassourl.format(self._search_keyword)
