...
class Footlocker(ShopBase):
    ...
    def parse_data(self, response):
        ...
        title = self.extract_items(response.css(".c-product-name ::text").extract())
        description = self.extract_items(response.css("#details-Details-panel .description ::text").extract())
