...
def get_desktop_user_agent():
        try:
            ...
            if user_agent is not None:
                ...
                if "Mobile" not in user_agent and "Phone" not in user_agent and "Touch" not in user_agent and "Trident" not in user_agent:
