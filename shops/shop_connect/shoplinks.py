class ShopLinks(object):
    ...
    _spiritualgangsterurl = "https://spiritualgangster.com/search?q={}"
    ...
    _nikeurl = "https://store.nike.com/us/en_us/pw/n/1j7?sl={}&vst={}"
    _adidasurl = "https://www.adidas.com/api/search/query?sitePath=us&query={}"
    _dicksportinggoodsurl = "https://www.dickssportinggoods.com/search/SearchDisplay?categoryId=&storeId=15108&catalogId=12301&langId=-1&sType=SimpleSearch&resultCatEntryType=2&showResultsPage=true&fromPage=Search&searchSource=Q&pageView=&beginIndex=0&DSGsearchType=Keyword&pageSize=48&nowcs=&searchTerm={}&advsearch=true"
    _biinkurl = "https://biink.com/search?type=product&q={}&submit=Search"
    _champsporturl = "https://www.champssports.com/api/products/search?products=&query={}&pageSize=60&timestamp=6"
